class Solution
{
    ...
    // bob has o choice, we can run something, which can say that bob visited these nodes at time 'x'

    // then we run a dfs for alice, check if she lands on node 'n' first or bob does, accordingly , we calculate alice ka prfit and move on
